...
def run_migrations_offline() -> None:
    """Generate SQL without opening an application database connection."""
...
async def run_migrations_online() -> None:
    """Run migrations through the async SQLAlchemy engine."""
...
def _run_migrations(connection) -> None:
    """Execute the migration context inside the sync bridge."""
    with context.begin_transaction():
        context.run_migrations()
