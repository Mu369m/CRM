...
from .api.v1.broker.infrastructure import router as infrastructure_router
from .api.v1.broker.features import router as broker_features_router
...
app.include_router(broker_features_router)
